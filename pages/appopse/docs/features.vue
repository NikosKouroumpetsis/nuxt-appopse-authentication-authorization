<template>
  <div>
    ...
    <p>
      The following are some of the features of Nuxt appopse. This page assumes
      you are using all the features of Nuxt appopse. If you&#39;re looking for
      API routes, please go to
      <NuxtLink to="/appopse/docs/backend">backend</NuxtLink> documentation.
    </p>
    <h2 id="user-registration">User Registration</h2>
    <p>
      Nuxt appopse comes with pages and an api that allow you to register a
      user.
    </p>
    ...
    <p>
      ...
      <code>/appopse/register</code>. See a
      <a href="https://nuxt-appopse.vercel.app/appopse/register"
        >live example</a
      >
    </p>
    ...
    <p>
      ...
      <code>appopse_VERIFY_REGISTRATIONS=&quot;true&quot;</code>. Please see
      <NuxtLink to="appopse/docs/configuration">Configuration</NuxtLink> for
    ...
    <p>
      ...
      <code>appopse_ALLOW_GOOGLE_AUTH=&quot;true&quot;</code> and
      <code>appopse_GOOGLE_CLIENT_ID=&quot;12345&quot;</code>. The 12345
      represents your Google client id.
    </p>
    <p>
      After that, navigate to the <code>/appopse/login</code> page, and click
      the Google button. See a
      <a href="https://nuxt-appopse.vercel.app/appopse/login">live example</a>
    </p>
    <h2 id="user-login">User login</h2>
    <p>
      Nuxt appopse comes with pages and an api that allow you to login as a
      user.
    </p>
    ...
    <p>
      ...
      <strong>password</strong> , navigate to the page
      <code>/appopse/login</code>. See a
      <a href="https://nuxt-appopse.vercel.app/appopse/login">live example</a>
    </p>
    <h3 id="google-login">Google login</h3>
    <p>
      To login using Google, navigate to the <code>/appopse/login</code> page,
      and click the Google button. Nuxt appopse will create an account for you
      using data from your Google account. See a
      <a href="https://nuxt-appopse.vercel.app/appopse/login">live example</a>
    </p>
    ...
    <p>
      ...
      <NuxtLink to="appopse/docs/configuration">Configuration</NuxtLink>. If you
      forget your password, navigate to the page <code>/appopse/reset</code>.
      See a
      <a href="https://nuxt-appopse.vercel.app/appopse/reset">live example</a>.
    </p>
    ...
    <p>
      ...
      administration. Nuxt appopse is designed to allow you to configure it how
      you want.
    </p>
    <h3 id="no-automatic-admin-access">No automatic admin access</h3>
    <p>
      All users who register with Nuxt appopse <strong>do not</strong> have
      access to the admin area. Nuxt appopse does not follow the policy of the
      first registered user automatically getting administrator rights as this
      is considered unsafe because a bad actor can assume that the very first
    ...
    <p>
      Nuxt appopse has a few roles and permissions. Nuxt appopse uses both
      role-based access control and attribute-based access control. Nuxt appopse
      has three types of roles: <code>SUPER_ADMIN</code>, <code>ADMIN</code>,
      and <code>GENERAL</code>.
    </p>
    <h4 id="roles">Roles</h4>
    <p>Nuxt appopse comes with three basic roles.</p>
    <ul>
      <li>
        <code>SUPER_ADMIN</code>: Is required to perform access the
        <NuxtLink to="appopse/docs/backend">users API</NuxtLink>, and is
        considered to be the most privileged role.
      </li>
      <li>
    ...
    <p>
      The only permission that comes with Nuxt appopse is
    ...
    <p>
      Most of Nuxt appopse is written in TypeScript. The Vue components are
    ...
    <p>
      ...
      CSS framework you need. Nuxt appopse may change to another CSS framework
      in the future.
    </p>
    <p>
    ...
    <p>
      ...
      CSS framework, but it allows Nuxt appopse to remain isolated from the rest
      of your app, and not interfere with already installed CSS frameworks you
      may have.
    </p>
  </div>
</template>
