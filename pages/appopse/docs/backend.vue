<template>
  <div class="container px-4 my-5 py-5 border shadow-lg" id="icon-grid">
    ...
    <p>
      Nuxt appopse provides you with an extensive backend. Below is an
      explanation of files and API logic that deals with the backend.
    </p>
    <h2 id="database">Database</h2>
    <p>
      Nuxt appopse requires a database to operate successfully, and uses
    ...
    <p>The default Nuxt appopse Prisma schema should look similar to</p>
  ...
  enum tokenType {
    ...
    <p>
      Nuxt appopse adds the following directories to your
      <strong>server/api</strong> directory.
    </p>
    <ul>
      <li><strong>appopse/autha</strong>: global authentication handler</li>
      <li><strong>appopse/refresh-tokens</strong>: refresh tokens handler</li>
      <li><strong>appopse/users</strong>: global users handler</li>
    </ul>
    ...
    <p>
      ...
      The <code>client-platform</code> header tells Nuxt appopse what type of
      client is sending the request, and can therefore provide the best security
      for the client.
    </p>
    <h3 id="client-platform">Client platform</h3>
    <p>
      <code>client-platform</code> is a <strong>required</strong> header and it
      must be sent with every request. Client platform allows Nuxt appopse to
    ...
    <p>
      ...
      successfully logs in, Nuxt appopse will respond with an
    ...
    <p>
      ...
      <code>/api/appopse/autha/refresh</code> with your expired access token and
      valid refresh token in the header, and you should get new tokens.
    </p>
    ...
    <span class="hljs-attr">"status"</span>: <span class="hljs-string">"success"</span>,
      <span class="hljs-attr">"data"</span>: {
          <span class="hljs-attr">"email"</span>: <span class="hljs-string">"nick@example.com"</span>
      }
  }
  </code></pre>
    <p>
    ...
    <h2 id="authentication-autha-api">Authentication (autha) API</h2>
    ...
    <p>
      Nuxt appopse adds the following authentication endpoints to your app. See
      examples below.
    </p>
    <ul>
      <li>
        <strong>/api/appopse/autha/profile</strong>: GET request will get the
        authenticated user&#39;s profile
      </li>
      <li>
        <strong>/api/appopse/autha/isauthenticated</strong>: GET request returns
        value determining whether user is authenticated (logged in) or not
      </li>
      <li>
        <strong>/api/appopse/autha/register</strong>: POST request registers a
        user
      </li>
      <li>
        <strong>/api/appopse/autha/login</strong>: POST request logs a user in
      </li>
      <li>
        <strong>/api/appopse/autha/login-google</strong>: POST request logs a
        user in using Google
      </li>
      <li>
        <strong>/api/appopse/autha/refresh</strong>: POST request gets a new
        pair of access and refresh tokens
      </li>
      <li>
        <strong>/api/appopse/autha/reset</strong>: POST request resets a
        user&#39;s password
      </li>
      <li>
        <strong>/api/appopse/autha/verifyreset/[token]</strong>: POST request
        sends password verification token
      </li>
      <li>
        <strong>/api/appopse/autha/verifyemailtoken</strong>: POST request to
        for email verification
      </li>
      <li>
        <strong>/api/appopse/autha/logout</strong>: POST request to log a user
        out
      </li>
      <li>
        <strong>/api/appopse/autha/update</strong>: PUT request to update user
        profile
      </li>
      <li>
        <strong>/api/appopse/autha/delete</strong>: DELETE request to delete
    ...
    <p>
      ...
      <code>/api/appopse/autha/register</code>.
    </p>
    ...
    <pre><code>const response = await $fetch(<span class="hljs-string">"/api/appopse/autha/register"</span>, {
    ...
    <p>
      To login, send a POST request to <code>/api/appopse/autha/login</code>.
    </p>
    <h4 id="request">Request</h4>
    <pre><code>const response = await $fetch(<span class="hljs-string">"/api/appopse/autha/login"</span>, {
      method: <span class="hljs-string">"<span class="hljs-keyword">POST</span>"</span>,
      headers: {
        <span class="hljs-string">"client-platform"</span>: 'app',
      },
    ...
    <pre><code><span class="hljs-string">"status"</span>: <span class="hljs-string">"success"</span>,
      <span class="hljs-string">"data"</span>: {
          <span class="hljs-string">"email"</span>: <span class="hljs-string">"nick@example.com"</span>
      }
  </code></pre>
    <h5 id="response-after-login">Response after login</h5>
    <pre><code><span class="hljs-attribute">appopse-access-token</span>: Bearer eyJhbGciOiJIUzI1NiIs...0g3IYFA

  <span class="armasm">
    appopse-refresh-token: <span class="hljs-keyword">Bearer </span>eyJhbGciOiJIUzI1...xIMUybnk</span>
  </code></pre>
    <p>
    ...
    <pre><code>const response = await $fetch(<span class="hljs-string">"/api/appopse/autha/refresh"</span>, {
      method: <span class="hljs-string">"<span class="hljs-keyword">POST</span>"</span>,
      headers: {
        <span class="hljs-string">"client-platform"</span>: <span class="hljs-string">"app"</span>,
        <span class="hljs-string">"appopse-access-token"</span>: <span class="hljs-string">"Bearer eyJhbGciOiJI....UzI1NiIs"</span>,
        <span class="hljs-string">"appopse-refresh-token"</span>: <span class="hljs-string">"Bearer eyJhbGcesTJI....UzI1NiIs"</span>,
      },
  </code></pre>
    <p>
    ...
    <p>
      To logout, send a POST request to <code>/api/appopse/autha/logout</code>.
    </p>
    <h4 id="request">Request</h4>
    <pre><code>const response = await $fetch(<span class="hljs-string">"/api/appopse/autha/logout"</span>, {
      method: <span class="hljs-string">"<span class="hljs-keyword">POST</span>"</span>,
      headers: {
        <span class="hljs-string">"client-platform"</span>: <span class="hljs-string">"app"</span>,
      },
    ...
    <p>
      If your client platform is <code>browser</code> or
      <code>browser-dev</code>, Nuxt appopse will delete your access and refresh
      ...
      <code>app</code>, Nuxt appopse will deactivate your refresh tokens in the
    ...
    <p>
      ...
      request to <code>/api/appopse/autha/profile</code>.
    </p>
    <h4 id="request">Request</h4>
    <pre><code>const response = await $fetch(<span class="hljs-string">"/api/appopse/autha/profile"</span>, {
      headers: {
    ...
    <p>
      ...
      <code>/api/appopse/autha/login-google</code>.
    </p>
    <h4 id="request">Request</h4>
    <pre><code>const response = await $fetch(<span class="hljs-string">"/api/appopse/autha/login-google"</span>, {
      method: <span class="hljs-string">"<span class="hljs-keyword">POST</span>"</span>,
      headers: {
        <span class="hljs-string">"client-platform"</span>: <span class="hljs-string">"browser"</span>,
      },
    ...
    <p>
      ...
      <code>/api/appopse/autha/isauthenticated</code>.
    </p>
    <h4 id="request">Request</h4>
    <p>
    ...
    const { <span class="hljs-built_in">status</span>, <span class="hljs-built_in">error</span> } = await $fetch(<span class="hljs-string">"/api/appopse/autha/isauthenticated"</span>, {
      headers: {
    ...
    <p>
      ...
      request to <code>/api/appopse/autha/update</code>.
    </p>
    ...
    <p>
      ...
      of proper usage, please see the <code>appopseDashboard</code> component,
      or the
      <NuxtLink to="/appopse/dashboard/admin"
        ><code>appopse/dashboard/admin</code></NuxtLink
      >
      page
    </p>
    <h4 id="request">Request</h4>
    <p>
      ...
      <strong>not</strong> the id. Nuxt appopse uses both id and uuid for a user
    ...
    <pre><code>const response = await $fetch(<span class="hljs-string">"/api/appopse/autha/update"</span>, {
    ...
    <p>
      ...
      <code>/api/appopse/autha/refresh</code>. Refreshing tokens will return a
      new access token and a new refresh token. All your other tokens will be
      invalidated.
    </p>
    <p>
    ...
    <p>
      ...
      If you use the Nuxt appopse frontend pages, you won&#39;t have to concern
    ...
    <p>
      ...
      request to <code>/api/appopse/autha/delete</code>.
    </p>
    <h4 id="request">Request</h4>
    <p>
    ...
    <pre><code>const response = await $fetch(<span class="hljs-string">"/api/appopse/autha/delete"</span>, {
    ...
    <p>
      ...
      <code>appopse/dashboard/settings</code> page.
    </p>
    <h3 id="reset-password">Reset password</h3>
    <p>
      To reset your password, send a POST request to
      <code>/api/appopse/autha/reset</code>.
    </p>
    <h4 id="request">Request</h4>
    <pre><code>const response = await $fetch(<span class="hljs-string">"/api/appopse/autha/reset"</span>, {
      method: <span class="hljs-string">"<span class="hljs-keyword">POST</span>"</span>,
      headers: {
        <span class="hljs-string">"client-platform"</span>: 'browser',
      },
    ...
    <p>
      ...
      always <code>success</code>. Nuxt appopse does not reveal whether the
      email exists or not.
    </p>
    ...
    <p>
      <em
        ...
        provided pages work in Nuxt appopse.</em
      >
    </p>
    <p>
      To verify a password reset token, send a POST request to
      <code>/api/appopse/autha/verifyreset</code>. A password reset token can
      only be verified <strong>once.</strong> Any further verifications will
      fail.
    </p>
    <h4 id="request">Request</h4>
    <pre><code>const response = await $fetch(<span class="hljs-string">"/api/appopse/autha/verifyreset"</span>, {
      method: <span class="hljs-string">"<span class="hljs-keyword">POST</span>"</span>,
      headers: {
        <span class="hljs-string">"client-platform"</span>: 'browser',
      },
    ...
    <p>
      ...
      <code>/api/appopse/autha/verifyemail</code>. An email with a verification
      token link will be sent to you. An email can only be verified
      <strong>once</strong>. Any other verifications will fail.
    </p>
    <h4 id="request">Request</h4>
    <pre><code>const response = await $fetch(<span class="hljs-string">"/api/appopse/autha/verifyemail"</span>, {
      method: <span class="hljs-string">"<span class="hljs-keyword">POST</span>"</span>,
      headers: {
        <span class="hljs-string">"client-platform"</span>: 'browser',
      },
    ...
    <p>
      ...
      <code>/api/appopse/autha/verifyemailtoken</code>.
    </p>
    <h4 id="request">Request</h4>
    <pre><code>const response = await $fetch(<span class="hljs-string">"/api/appopse/autha/verifyemailtoken"</span>, {
      method: <span class="hljs-string">"<span class="hljs-keyword">POST</span>"</span>,
      headers: {
        <span class="hljs-string">"client-platform"</span>: clientPlatform,
      },
    ...
    <p>
      Nuxt appopse adds the following users endpoints to your app. See examples
      below.
    </p>
    <ul>
      <li>
        <strong>/api/appopse/users</strong>: GET request will return all users.
        Maximum return is 100 users. Use <code>skip</code> and
        <code>take</code> request parameters to get a set of users e.g.,
        <code>/api/appopse/users?skip=40&amp;take=20</code>. See more
        information on
        <a
      ...
      <li>
        <strong>/api/appopse/users/[uuid]</strong>: GET a specific user record
        given the user&#39;s uuid. uuid is <strong>not</strong> the user&#39;s
        id. Both are unique, but function differently. uuid is displayed
        publicly, but the user id is used mostly internally.
      </li>
      <li>
        <strong>/api/appopse/users</strong>: POST request will
        <strong>not</strong> create a user. It will return a 422 error. You must
        use <code>/api/appopse/autha/register</code> to create a user.
      </li>
      <li>
        <strong>/api/appopse/users/[uuid]</strong>: PUT request updates a user
        given the user&#39;s uuid
      </li>
      <li>
        <strong>/api/appopse/users/[uuid]</strong>: DELETE request deletes a
        user given the user&#39;s uuid
      </li>
    </ul>
    ...
    <p>
      User data is considered a restricted resource and therefore Nuxt appopse
    ...
    <p>
      To get all users, send a GET request to <code>/api/appopse/users</code>.
    </p>
    <h4 id="request">Request</h4>
    <p>
    ...
    <pre><code>const response = await $fetch(<span class="hljs-string">"/api/appopse/users"</span>, {
      headers: {
        <span class="hljs-string">"client-platform"</span>: <span class="hljs-string">"app"</span>,
      },
    });
    ...
    <pre><code>const response = await $fetch(<span class="hljs-string">"/api/appopse/users?skip=40&amp;take=10"</span>, {
      headers: {
        <span class="hljs-string">"client-platform"</span>: <span class="hljs-string">"app"</span>,
      },
    });
    ...
    <p>
      ...
      <code>/api/appopse/users/[uuid]</code>. <code>uuid</code> needs to be a
      valid user uuid.
    </p>
    <h4 id="request">Request</h4>
    <pre><code>const response = await $fetch(<span class="hljs-string">"/api/appopse/users/[uuid]"</span>, {
      headers: {
        <span class="hljs-string">"client-platform"</span>: <span class="hljs-string">"app"</span>,
      },
    });
    ...
    <h4 id="request">Request</h4>
    <pre><code>const response = await $fetch(`/api/appopse/users/<span class="hljs-string">[uuid]</span>`, {
      method: <span class="hljs-string">"<span class="hljs-keyword">PUT</span>"</span>,
      headers: {
        <span class="hljs-string">"client-platform"</span>: <span class="hljs-string">"app"</span>,
      },
    ...
    <p>
      ...
      Nuxt appopse allows only <strong>one</strong> refresh token to be active
      at any one time. To first get access and refresh tokens, a user must log
      in. Once logged in, Nuxt appopse will send the user one access token and a
      refresh token.
    </p>
    <p>
    ...
    <p>
      Nuxt appopse allows you to work with refresh tokens as a security measure.
      Refresh tokens are JSON (JavaScript Object Notation) web tokens. They are
      automatically generated and signed by Nuxt appopse. Any change in the
      token invalidates the token. A user with an invalid refresh token will not
      be able to obtain a new set of access and refresh tokens. The user will
      need to successfylly authenticate (log in) to get a new set of tokens.
    </p>
    <p>Nuxt appopse provides a limited number of refresh token endpoints.</p>
    <h3 id="refresh-tokens-api-endpoints">Refresh Tokens API Endpoints</h3>
    <p>
      Nuxt appopse adds the following refresh tokens endpoints to your app. See
      examples below.
    </p>
    <ul>
      <li>
        <strong>/api/appopse/refresh-tokens</strong>: GET request will return
        all users. Maximum return is 100 users. Use <code>skip</code> and
        <code>take</code> request parameters to get a set of refresh tokens
        e.g., <code>/api/appopse/refresh-tokens?skip=40&amp;take=20</code>. See
        more information on
        <a
          href="https://www.prisma.io/docs/concepts/components/prisma-client/pagination"
          >Prisma pagination</a
      ...
      <li>
        <strong>/api/appopse/refresh-tokens/[id]</strong>: DELETE request
        deletes a specific refresh token. This forces the token user to have to
        log in once their access token expires.
      </li>
      <li>
        <strong>/api/appopse/refresh-tokens</strong>: DELETE request deletes all
    ...
    <p>
      ...
      appopse requires that anyone accessing user data be authenticated and
    ...
    <p>
      ...
      <code>/api/appopse/refresh-tokens</code>.
    </p>
    <h4 id="request">Request</h4>
    <p>
    ...
    <pre><code>const response = await $fetch(<span class="hljs-string">"/api/appopse/refresh-tokens"</span>, {
      headers: {
        <span class="hljs-string">"client-platform"</span>: <span class="hljs-string">"app"</span>,
      },
    });
    ...
    <p>
      ...
      <code>/api/appopse/refresh-tokens/[id]</code>. This will force the user to
      login after their access token has expired.
    </p>
    <h4 id="request">Request</h4>
    <pre><code>const response = await $fetch(`/api/appopse/refresh-tokens/<span class="hljs-string">[id]</span>`, {
      method: <span class="hljs-string">"<span class="hljs-keyword">DELETE</span>"</span>,
      headers: {
        <span class="hljs-string">"client-platform"</span>: <span class="hljs-string">"browser"</span>,
      },
    ...
    <p>
      ...
      <code>/api/appopse/refresh-tokens</code>. This will force all users to
      login after each of their access tokens expire.
    </p>
    <h4 id="request">Request</h4>
    <pre><code>const response = await $fetch(`/api/appopse/refresh-tokens/`, {
      method: <span class="hljs-string">"<span class="hljs-keyword">DELETE</span>"</span>,
      headers: {
        <span class="hljs-string">"client-platform"</span>: <span class="hljs-string">"browser"</span>,
      },
