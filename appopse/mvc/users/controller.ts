...
import { canAccessAdmin } from "~~/appopse/autha/permissions";
import { isOwner } from "~~/appopse/autha/helpers";
import { validateCsrfToken } from "~~/appopse/misc/utils/tokens";
...
export default useBase("/api/appopse/users", router.handler);
